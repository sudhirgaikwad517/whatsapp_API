...
/**
 * Shared 6-digit OTP entry step — used right after registration (Signup.tsx)
 * and when a login attempt hits EMAIL_NOT_VERIFIED (Login.tsx), since both
 * are "finish verifying this email" moments backed by the same
 * verify-signup-otp / resend-signup-otp endpoints.
 */
    ...
    <div className="space-y-4">
      ...
      <form onSubmit={handleVerify} className="space-y-4">
        ...
        <button
          ...
          className="w-full bg-emerald-600 hover:bg-emerald-500 text-white font-bold py-3 rounded-xl text-xs transition-all shadow-lg shadow-emerald-500/30 cursor-pointer disabled:opacity-50"
        >
      ...
      <div className="text-center text-xs text-slate-400">
        ...
        <button
          ...
          className="text-emerald-400 hover:underline font-semibold disabled:opacity-50 disabled:no-underline cursor-pointer"
        >
