 ...
 * when its secret key isn't configured. Same component as
 * apps/frontend/src/components/ui/TurnstileWidget.tsx — duplicated here
 * because this is a separate repo/deploy, not shared code.
 */
